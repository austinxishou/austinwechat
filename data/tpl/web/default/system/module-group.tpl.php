			...
			<tr >
				...
				<td class="text-left">
					<div class="link-group">
						...
						<a href="<?php  echo url('system/module-group/delete', array('id' => $module_group['id']))?>" onclick="return confirm('确定要删除套餐吗？')">删除</a>
						<?php  } ?>
					</div>
				</td>
			</tr>
					...
					<div class="panel-body we7-padding">
						<div class="row">
							<div class="col-sm-2 text-center we7-margin-bottom select-module" ng-repeat="module in groupNotHaveModuleApp" style="overflow: hidden">
								...
								<span id="module-{{module.mid}}" class="selected hidden" ng-click="cancleModule(module, 'module')" style="position:absolute;width:82%;height:100%;left:10px;top:0;opacity:0.8;cursor:pointer;background:#e7e8eb; vertical-align:middle;font-size:45px;border-radius:5px;"><i class="wi wi-right-sign color-green"></i></span>
							</div>
						</div>
					</div>
				</div>
