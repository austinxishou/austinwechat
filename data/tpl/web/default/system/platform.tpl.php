...
<div id="js-system-platform" ng-controller="SystemPlatform" ng-cloak>
	<table class="table we7-table table-hover table-form">
		...
		<tr>     
			...
			<td><a href="javascript:;" class="color-default" data-toggle="modal" data-target="#AppID">修改</a></td>
		</tr>
		<tr>
			...
			<td><a href="javascript:;" class="color-default" data-toggle="modal" data-target="#AppSecret">修改</a></td>
		</tr>
	</table>
	...
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			...
			<td><a href="javascript:;" id="copy-0" class="color-default" clipboard supported="supported" text="url.host" on-copied="success('0')">点击复制</a></td>
		</tr>
		<tr>
			...
			<td><a href="javascript:;" id="copy-1" class="color-default" clipboard supported="supported" text="url.host+url.path+'web/index.php?c=account&a=auth&do=test'" on-copied="success('1')">点击复制</a></td>
		</tr>
		<tr>
			...
			<td><a href="javascript:;" id="copy-2" class="color-default" clipboard supported="supported" text="url.host+url.path+'web/index.php?c=account&a=auth&do=ticket'" on-copied="success('2')">点击复制</a></td>
		</tr>
		<tr>
			...
			<td class="link-group">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#token">修改</a>
				<a href="javascript:;" ng-click="httpChange('token')">生成新的</a>
				<a href="javascript:;" id="copy-3" class="color-default" clipboard supported="supported" text="platform.token" on-copied="success('3')">点击复制</a>
			</td>
		</tr>
		<tr>
			...
			<td class="link-group">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#encodingaeskey">修改</a>
				<a href="javascript:;" ng-click="httpChange('encodingaeskey')">生成新的</a>
				<a href="javascript:;" id="copy-4" class="color-default" clipboard supported="supported" text="platform.encodingaeskey" on-copied="success('4')">点击复制</a>
			</td>
		</tr>
		<tr>
			...
			<td><a href="javascript:;" id="copy-5" class="color-default" clipboard supported="supported" text="url.host+url.path+'api.php?appid=/$APPID$'" on-copied="success('5')">点击复制</a></td>
		</tr>
		<tr>
			...
			<td><a href="javascript:;" id="copy-6" class="color-default" clipboard supported="supported" text="url.host" on-copied="success('6')">点击复制</a></td>
		</tr>
	</table>
