			...
			<tr ng-repeat="module in module_list">
				...
				<td class="text-left">
					<div class="link-group">
						...
						<a href="<?php  echo url('system/module/uninstall')?>&name={{ module.name }}" ng-if="isFounder == 1">停用</a>
	...
	<div class="panel we7-panel module-subscription" ng-if="isFounder == 1">
		...
		<div class="panel-body">
			<ul>
				...
				<li><?php  echo $mtypes[$subscribe];?> <lable ng-if="subscribe == 2" class="label label-danger">通讯失败</lable>  </li>
				<?php  } } ?>
			</ul>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<table class="table we7-table vertical-middle">
						...
						<col width="400px">
						<tr>
							<th colspan="3" class="text-left"><?php  echo $module_info['title'];?>---模块分支信息</th>
						</tr>
						<tr>
							<td class="text-left">
								分支名称
						...
						<tr ng-repeat="branch in upgradeInfo.branches">
							...
							<td class="text-right">
								<div class="link-group">
									<a tabindex="2" href="javascript:;" role="button" data-toggle="popover" title="<?php  echo $module_info['title'];?>升级说明" data-container="#upgrade-Info" data-placement="bottom" data-trigger="focus" data-html="true" data-content="{{ branch.version.description }}">升级说明</a>
									<a ng-href="{{ './index.php?c=cloud&a=process&m='+upgradeInfo.name+'&is_upgrade=1' }}" onclick="return confirm('确定要升级到此分之的最新版吗？')" ng-if="branch.id == upgradeInfo.site_branch.id">免费升级到【{{branch.name}}】最新版本</a>
									<a href="javascript:;" ng-click="upgrade(branch.upgrade_price, upgradeInfo.name, branch.id)" ng-if="branch.id > upgradeInfo.site_branch.id">付费升级到【{{branch.name}}】最新版本</a>
								</div>
							</td>
